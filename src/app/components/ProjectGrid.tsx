              ...
              <div className="flex flex-col justify-center items-center  pr-0 md:px-10">
                ...
                <div className="relative mt-7 md:mt-0">
                  <div className=" mt-4 md:mt-16 grid grid-cols-1 gap-x-10 gap-y-10 md:grid md:grid-cols-2">
                          <ProjectCard  name={Projects[0].name} imgSrc={Projects[0].imgSrc} year={2025}/>
                          <ProjectCard  name={Projects[1].name} imgSrc={Projects[1].imgSrc} year={2025}/>
                           <ProjectCard  name={Projects[2].name} imgSrc={Projects[2].imgSrc} year={2025}/>
                            <ProjectCard  name={Projects[3].name} imgSrc={Projects[3].imgSrc} year={2025}/>
